package com.example.coffeeshop.Activity.Adapter
...
class CartAdapter(
    ...
    override fun onBindViewHolder(holder: CartAdapter.Viewholder, position: Int) {
        ...
        holder.binding.tvPriceItem.text="$${item.price}"
        holder.binding.tvPriceTotal.text="$${item.numberInCart*item.price}"
        holder.binding.tvNumber.text=item.numberInCart.toString()
        ...
        holder.binding.tvMais.setOnClickListener {
        ...
        holder.binding.tvMenos.setOnClickListener {
